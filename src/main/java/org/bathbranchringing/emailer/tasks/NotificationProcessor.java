    ...
    public void sendNotifications() {
        ...
        for (Notification notification : queue) {
            ...
            if (!noticeMap.containsKey(noticeId)) {
                LOG.debug(String.format("Adding new notification for notice %d", noticeId));
                ...
                if (noticeMap.get(noticeId).getCreationDate().before(notification.getCreationDate())) {
                    ...
                    noticeMap.put(noticeId, noticeMap.get(noticeId));
                }
                
                LOG.debug(String.format("Obsolete notification %d found, updated and removed", obsoleteNotification.getId()));
